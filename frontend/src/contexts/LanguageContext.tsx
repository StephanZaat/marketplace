...
const translations: Record<Lang, any> = {
  en: {
    ...
    enterEmail: "Enter your email — we'll send you a code. New here? An account is created automatically.",
  ...
  es: {
    ...
    enterEmail: "Ingresa tu correo — te enviaremos un código. ¿Eres nuevo? Se crea una cuenta automáticamente.",
